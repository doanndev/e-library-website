...
export default function Information() {
  return (
    <div className="section  w-full  relative  xl:flex  lg:flex  bg-[#F4F6FD]  md:flex  justify-center">
      <div className="section_left  xl:w-[75%]  h-[auto]  mb-[20px]  lg:w-[65%]  md:w-[100%]  sm:w-[100%]  w-[100%]">
          <div className="content_section_left xl:mt-[130px]  xl:pt-0  w-full h-auto xl:pl-[10.15%]  lg:pt-0  lg:mt-[86px]  lg:pl-[10.15%]  md:pt-[65px]  md:pl-[8.15%]  sm:pt-[50px]  sm:pl-[8.15%]  pt-[50px]  pl-[8.15%]  pr-[8.15%]">
          ...
          <div className='xl:w-0  xl:h-0  lg:w-0  lg:h-0  md:w-[100%]  md:h-[600px]  md:flex  justify-center  sm:w-[100%]  sm:h-[600px]  w-[100%]  h-auto  mt-[15px]'>
            <Image src={images.Illustration} alt={''} className='xl:hidden  xl:w-[906px]  xl:min-w-[750px]  lg:hidden  lg:min-w-0  lg:w-[680px]  md:w-[610px]  md:block  sm:w-[610px]  sm:block  sm:mx-auto  w-[610px]'/>
          </div>
          <div className="box_section_left  w-full h-auto  flex  xl:pl-[9.3%]  lg:pl-[8.6%]">
            <div className="buttom_section_left  xl:w-[60%]  lg:w-[100%]  md:w-[100%]  sm:w-[100%]  w-[100%]">
              <div className='w-full  h-auto  xl:w-full  xl:h-auto  lg:w-[80%]  flex justify-center'>
                <button className="xl:ml-[22px]  xl:p-[19px]  xl:px-[20px]  xl:mr-auto  xl:mt-[75px]  w-[73%]  h-[39%]  rounded-[10px]  text-white  bg-[#FF7F56]  border-none  lg:ml-0  lg:mr-[18%]  lg:mt-[80px]  lg:p-[17px]  md:mt-[0px] md:p-[17px]  md:max-w-[600px]  sm:mt-[20px] sm:p-[17px]  sm:max-w-[600px]  mt-[20px] p-[17px]  max-w-[600px]">
                  <p className='font-semibold  text-[25.48px]  leading-[29.85px]'>Get Started For Free</p>
                </button>
              </div>
              <div className='xl:pl-[5.9%]  xl:pt-[143px]  xl:mb-0  lg:pt-[75px]  lg:pl-[3.9%]  lg:mb-0  md:pt-[50px]  md:w-[100%]  md:pl-[80px]  md:mb-0  sm:pt-[50px]  sm:w-[100%]  sm:pl-[80px]  sm:mb-0  pt-[50px]  w-[100%]  pl-[44px]  mb-[20px]'>
                ...
                <div className="xl:pt-[25px]  box_icon  w-full  h-auto  flex  lg:pt-[25px]  md:pt-[25px]  sm:pt-[25px]  pt-[25px]">
                  ...
                  <Image src={images.icon_park_email_block} alt={''} className='w-[48px]  h-[48px]  xl:mr-[6%]  xl:mt-[5px]  lg:mr-[5.83%]  lg:mt-[5px]  md:mr-[5.83%]  md:mt-[5px]  sm:mr-[5.83%]  sm:mt-[5px]  mr-[5.83%]  mt-[5px]'/>
      ...
      <div className="section_Right  xl:w-[25%]  xl:h-[auto]  lg:w-[35%]  lg:h-auto  md:w-[0%]  sm:w-[0%]  w-[0%]"></div>
      <div className='absolute  hidden  xl:block  xl:w-auto xl:h-auto  xl:right-0  xl:left-[41%]  xl:top-[96px]  lg:block  lg:left-[43%]  lg:w-auto  lg:h-auto  lg:right-0  lg:top-[180px]  md:right-[12%]  md:top-[355px]  md:w-auto  md:h-auto  md:hidden  sm:top-[420px]  sm:w-auto  sm:h-auto  sm:hidden  top-[420px]  w-auto  h-auto'>
